...
import 'package:dart_recipe_schema/src/utils/rdfa_parser.dart';
import 'package:html/parser.dart';
import 'package:test/test.dart';

void main() {
  test("Running microdata", () {
    var rdfaFile = File("test/test_inputs/rdfa.html").readAsStringSync();
    var rdfaMicrodata = parse(rdfaFile);
    List<StructuredData> data = RdfaParser.extractRdfa(rdfaMicrodata);
